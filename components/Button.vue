...
const styles = reactive<{
  ...
  secondary:
    'text-slate-800 bg-gray-200 border-gray-200 hover:bg-gray-300 dark:text-white dark:border-white dark:bg-blue-480 dark:hover:bg-white dark:hover:text-blue-480',
  opposite:
